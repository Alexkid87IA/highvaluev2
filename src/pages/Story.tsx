...
export default function Story() {
  const categoryData = {
    ...
    description: "Des histoires inspirantes qui changent les perspectives et ouvrent le champ des possibles.",
    subcategories: ["Entrepreneurs", "Artistes", "Sportifs", "Innovateurs", "Leaders"],
  };
